        ...
        <div className="bg-black p-8 grid gap-4">
          ...
          {place?.photos?.length > 0 &&
            place.photos.map((photo, index) => (
              <div key={index}>
                <img src={"https://airbnb-organichousebooking-4-client.onrender.com/uploads/" + photo} />
              </div>
            ))}
        </div>
      </div>
        ...
        <div className="grid">
          {place.photos?.[1] && (
            <img
              onClick={() => setshowAllPhotos(true)}
              className="aspect-square object-cover cursor-pointer w-full"
              src={"https://airbnb-organichousebooking-4-client.onrender.com/uploads/" + place.photos[1]}
              alt=""
            />
          )}
          ...
          <div className="overflow-hidden">
            {place.photos?.[2] && (
              <img
                onClick={() => setshowAllPhotos(true)}
                className="aspect-square object-cover cursor-pointer w-full"
                src={"https://airbnb-organichousebooking-4-client.onrender.com/uploads/" + place.photos[2]}
                alt=""
              />
            )}
          </div>
